...
from django.contrib import admin
from .models import Payment, Station,  Driver, Bus, Route, Booking, UserProfile, Complain,Article,HomepageText,Faqs, OurService, PopulerRoute,Schedule,WorkingHour
...
class UserProfileAdmin(admin.ModelAdmin):
    list_display = ('id', 'user',  'phone_number','state_of_origin','local_government', 'address', 'nin_number','date_of_birth','profile_picture')
...
class ComplainAdmin(admin.ModelAdmin):
    list_display = ('id', 'user','subject', 'description','is_resolved','timestamp')
